"""
https://github.com/Lightning-AI/pytorch-lightning/issues/10914#issuecomment-993769544
"""
...
class EMA(L.Callback):
    ...
    def on_save_checkpoint(
        ...
        checkpoint.update({"ema_state_dict": self.ema_state_dict, "_ema_state_dict_ready": self._ema_state_dict_ready})
